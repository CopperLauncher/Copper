...
4. Copper developers reserve the right to update this privacy policy without prior notification.
5. Copper has an option to share your logs to a third-party service (https://mclo.gs/) at your request. Once shared, we have no control over that data.
